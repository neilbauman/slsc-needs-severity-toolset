    ...
    BEGIN
        ...
        v_dataset_name := 'Bangladesh Population Density - ADM3';
        
        SELECT id INTO v_dataset_id
        FROM datasets
        WHERE country_id = '0aa6850c-b932-444b-88b4-7e29ea8cc0bc'
        ...
        IF v_dataset_id IS NULL THEN
            INSERT INTO datasets (
                ...
                v_dataset_name,
                'Population density (persons per km²) by ADM3 administrative units for Bangladesh. Calculated from population and boundary area data.',
                'numeric',
                'ADM3',
                '0aa6850c-b932-444b-88b4-7e29ea8cc0bc',
                true,
                'Calculated from population and boundary data',
                jsonb_build_object(
                    'calculated_from_population_dataset', 'b3ff17df-b342-4844-ad23-4b0966c6d35d',
        ...
        WITH population_data AS (
            ...
            WHERE dataset_id = 'b3ff17df-b342-4844-ad23-4b0966c6d35d'
        ),
        boundary_areas AS (
            SELECT 
                admin_pcode,
