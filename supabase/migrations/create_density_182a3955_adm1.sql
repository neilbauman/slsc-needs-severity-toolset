    ...
    BEGIN
        ...
        v_dataset_name := 'Palestine Population Density - ADM1';
        
        SELECT id INTO v_dataset_id
        FROM datasets
        WHERE country_id = '182a3955-09c7-40b3-a036-962e76c695fb'
        ...
        IF v_dataset_id IS NULL THEN
            INSERT INTO datasets (
                ...
                v_dataset_name,
                'Population density (persons per km²) by ADM1 administrative units for Palestine. Calculated from population and boundary area data.',
                'numeric',
                'ADM1',
                '182a3955-09c7-40b3-a036-962e76c695fb',
                true,
                'Calculated from population and boundary data',
                jsonb_build_object(
                    'calculated_from_population_dataset', '6d055978-7156-4814-a14f-ee5614b3ba97',
        ...
        WITH population_data AS (
            ...
            WHERE dataset_id = '6d055978-7156-4814-a14f-ee5614b3ba97'
        ),
        boundary_areas AS (
            SELECT 
                admin_pcode,
