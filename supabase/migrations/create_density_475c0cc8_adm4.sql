    ...
    BEGIN
        ...
        v_dataset_name := 'Philippines Population Density - ADM4';
        
        SELECT id INTO v_dataset_id
        FROM datasets
        WHERE country_id = '475c0cc8-7cba-426b-bd1b-ef807e8c5710'
        ...
        IF v_dataset_id IS NULL THEN
            INSERT INTO datasets (
                ...
                v_dataset_name,
                'Population density (persons per km²) by ADM4 administrative units for Philippines. Calculated from population and boundary area data.',
                'numeric',
                'ADM4',
                '475c0cc8-7cba-426b-bd1b-ef807e8c5710',
                true,
                'Calculated from population and boundary data',
                jsonb_build_object(
                    'calculated_from_population_dataset', '2645df55-e487-4779-a575-a40be95354c8',
        ...
        WITH population_data AS (
            ...
            WHERE dataset_id = '2645df55-e487-4779-a575-a40be95354c8'
        ),
        boundary_areas AS (
            SELECT 
                admin_pcode,
