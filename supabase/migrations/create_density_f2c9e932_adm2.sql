    ...
    BEGIN
        ...
        v_dataset_name := 'Mozambique Population Density - ADM2';
        
        SELECT id INTO v_dataset_id
        FROM datasets
        WHERE country_id = 'f2c9e932-1ab3-41fd-b455-35a0fcb7c518'
        ...
        IF v_dataset_id IS NULL THEN
            INSERT INTO datasets (
                ...
                v_dataset_name,
                'Population density (persons per km²) by ADM2 administrative units for Mozambique. Calculated from population and boundary area data.',
                'numeric',
                'ADM2',
                'f2c9e932-1ab3-41fd-b455-35a0fcb7c518',
                true,
                'Calculated from population and boundary data',
                jsonb_build_object(
                    'calculated_from_population_dataset', '83150e8f-ca4a-49f3-88f2-be3cdd5ea616',
        ...
        WITH population_data AS (
            ...
            WHERE dataset_id = '83150e8f-ca4a-49f3-88f2-be3cdd5ea616'
        ),
        boundary_areas AS (
            SELECT 
                admin_pcode,
